...
class XmattersListTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.err_json_str1 = (
            ...
            404, "Not Found",
            "Could not find a person with id 0313142d3-4703-a90e-36cc5f5f6209")
        self.err1 = Error.from_json_str(self.err_json_str1)
        self.err_json_str2 = ((
            '{"code" : %d, "reason" : "%s", "message" : '
            '"%s"}')%(
            200, "OK",
            "Found a person with id 0313142d3-4703-a90e-36cc5f5f6209"))
        self.err2 = Error.from_json_str(self.err_json_str2)
        self.err_json_str3 = ((
            '{"code" : %d, "reason" : "%s", "message" : '
            '"%s"}')%(
            202, "Submitted",
            "Submitted search for person id 0313142d3-4703-a90e-36cc5f5f6209"))
        self.err3 = Error.from_json_str(self.err_json_str3)
        self.err_json_str1 = '[%s, %s, %s]'%(
            self.err_json_str1, self.err_json_str2, self.err_json_str3)
    ...
    def test_TestList(self):
        ...
        for tl in range(3):
            self.assertIsInstance(tlobj[tl], Error)
            XLOGGER.debug(
